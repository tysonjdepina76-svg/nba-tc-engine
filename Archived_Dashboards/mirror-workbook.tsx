// ARCHIVED: /mirror-workbook route from zo.space — removed 2026-07-27
// Original route: https://true.zo.space/mirror-workbook (private)
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-zinc-900 rounded-2xl p-8 border border-zinc-800">
            ...
            <ul className="space-y-3 text-zinc-400">
              ...
              <li className="flex items-start gap-3">
                <span className="text-amber-500 mt-1">•</span>
                <span>ACEs Framework (Adverse Childhood Experiences)</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-amber-500 mt-1">•</span>
                <span>Complex PTSD (Judith Herman)</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-amber-500 mt-1">•</span>
                <span>Somatic Trauma Therapy (Peter Levine)</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-amber-500 mt-1">•</span>
              ...
              <li className="flex items-start gap-3">
                <span className="text-amber-500 mt-1">•</span>
                <span>Post-Traumatic Growth Research</span>
              </li>
            </ul>
          </div>
        </div>
