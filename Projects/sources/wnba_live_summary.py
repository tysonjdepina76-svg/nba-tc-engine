"""
Fetch live WNBA games with lineups and live stats.
"""
...
STAT_MAP = {
    ...
    "threePointFieldGoalsMade": "fg3",
    "steals": "stl",
    "blocks": "blk"
}

def fetch_wnba_live_summary():
    """Fetch live WNBA games with lineups and live stats."""
    ...
    for event in data.get("events", []):
        ...
        summary_url = f"https://site.api.espn.com/apis/site/v2/sports/basketball/wnba/summary?event={event_id}"
...
def fetch_wnba_live_cached():
    return cache_fetch("wnba_live_summary", fetch_wnba_live_summary, ttl_hours=0.0167)
